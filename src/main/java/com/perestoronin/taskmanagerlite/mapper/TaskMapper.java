...
import com.perestoronin.taskmanagerlite.dto.tasks.AllAttribTasksDto;
...
public class TaskMapper {
    ...
    public AllAttribTasksDto toFullTaskResponseDto(Tasks task) {
        AllAttribTasksDto dto = new AllAttribTasksDto();
